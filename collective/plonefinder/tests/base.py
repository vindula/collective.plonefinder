# -*- coding: utf-8 -*-
# $Id: base.py 232024 2011-02-12 21:27:12Z glenfant $
...
def setup_product():
    ...
    zcml.load_config('configure.zcml', collective.plonefinder)
...
setup_product()
ptc.setupPloneSite(products=['collective.plonefinder'])
